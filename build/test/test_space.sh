...
echo "challenge accepted - barney stinson"
...
export _TESTS="$_TESTS template_extract template_library template_spawn template_extract_cleanup template_spawn_cleanup template_extract_library"
